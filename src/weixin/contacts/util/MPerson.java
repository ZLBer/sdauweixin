...
public class MPerson {
	 ...
	 * */
	public static String Create(String  userid,String name ,String mobile ){
		String PostData = "{\"userid\": %s,\"name\": %s,\"department\": %s,\"mobile\": %s}";
		String userid1="\""+userid+"\"";
		String name1="\""+name+"\"";
		String mobile1="\""+mobile+"\"";
		String department1="\""+112+"\"";
		return String.format(PostData, userid1,name1,department1,mobile1);
	}
	 ...
	 * */
	public static String Updata(String userid, String name, String mobile){
		String PostData = "{\"userid\": %s,\"name\": %s,\"mobile\": %s}";
		String userid1="\""+userid+"\"";
		String name1="\""+name+"\"";
		String mobile1="\""+mobile+"\"";
		return String.format(PostData,userid1,name1,mobile1);
	}
	/**
	 * 删除成员
	...
	public static void main(String[] args) {
		...
		// 拼装数据
		String PostData = Create("员工UserID", "Engineer-JSP",  "150xxxx8524");
		// 提交数据，获取结果
