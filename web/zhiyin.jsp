...
<p>从企业发布入口进入提交招聘信息的页面。<br/></p>
<p></p>
<font size="+2">第二步、</font>
<p>根据提示填入相关需求信息，要求包括公司名称、联系人、联系方式、招聘简章等；添加的招聘简章正文可在 word
...
<p>填写需求人数，点击“添加”依次选择增加所需专业及人数，点击编辑区下方“下一步”继续操作。
...
<p></p>
 ...
 <p>点击“下一步”。上传企业营业执照电子版图片(<font color="red">图片格式请务必是.gif,jpeg,jpg,png</font>)。</p>
<!--<img src="images/4.1.png" width="750px" height="400px"/><br />-->
选择完图片后点击“提交”。<br />
<p></p>
<font size="+2">第五步、</font>
<p>扫描二维码关注微信号，审核结果会以微信的形式通知您。</p>
<!--<img src="images/5.png" width="750px" height="400px"/><br />-->
<p style="line-height: 50px;"><font color="red" >温馨提示：企业联系电话请填写手机号，以便接收关注微信平台的验证码；关注微信平台后，
我们会将审核结果及时发送至您的微信上。</font></p>
<div class="div2">
    <a href="${pageContext.request.contextPath}/enterprise/input_first.jsp" ><img src="images/duihuakuang3.png" style="width: 430px;height: 140px;"></a>
</div>
</div>
</body>
</html>
