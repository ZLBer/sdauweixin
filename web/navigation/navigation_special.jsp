...
<head>
    ...
    <script type="text/javascript" src="/navigation/ckeditor/ckeditor.js"></script>
...
<body>
<form action="${pageContext.request.contextPath}/navigation/navigation_special" method="post" id="query">
...
<c:if test="${recordCount>0}">
    <form action="${pageContext.request.contextPath}/navigation/navigation_modify" method="post" name="filter">
        <table border="1" frame="void" class="easyui-datagrid" id="content"
            ...
            <thead>
            <tr>
                <th data-options="field:'1'"><a id="select_all_a" href="javascript:selectAll()">全选</a>
                </th>
                <th data-options="field:'2'">状态</th>
                <th data-options="field:'3'">审核栏</th>
                <th data-options="field:'4'">企业号</th>
