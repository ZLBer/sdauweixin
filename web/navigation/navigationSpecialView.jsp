...
<body>
<form action="${pageContext.request.contextPath}/navigation/navigationSpecialView" method="post" id="query">
...
<c:if test="${recordCount>0}">
    <form action="${pageContext.request.contextPath}/navigation/navigationSpecialView" method="post">
